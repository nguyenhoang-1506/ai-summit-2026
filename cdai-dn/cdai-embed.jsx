...
(function () {
  ...
  const MAP = D.secs.map((s, i) => i).filter(i => ![21,22].includes(i));
  ...
  function CycleDaiEmbed({ idx = 0, showCaptions = true, speed = 1 }) {
    ...
    return React.createElement('div', { ref: boxRef, style: { position: 'absolute', left: 0, top: 0, width: 3840, height: 1280, overflow: 'hidden' } },
